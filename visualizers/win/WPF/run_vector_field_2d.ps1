...
# Using WPF MML_VectorField2D_Visualizer

# Configuration
$ScriptDir = Split-Path -Parent $MyInvocation.MyCommand.Path
$VisualizerPath = Join-Path $ScriptDir "vector_field_2d_visualizer\MML_VectorField2D_Visualizer.exe"
$DataDir = Join-Path $ScriptDir "..\..\..\data\VectorFieldVisualizer2D\Basic"
