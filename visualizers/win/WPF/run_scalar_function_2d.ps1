...
# Using WPF MML_ScalarFunction2D_Visualizer

# Configuration
$ScriptDir = Split-Path -Parent $MyInvocation.MyCommand.Path
$VisualizerPath = Join-Path $ScriptDir "scalar_function_2d_visualizer\MML_ScalarFunction2D_Visualizer.exe"
$DataDir = Join-Path $ScriptDir "..\..\..\data\ScalarFunction2D\Basic"

# Color settings
$Host.UI.RawUI.ForegroundColor = "Cyan"

Write-Host "========================================" -ForegroundColor Green
Write-Host "Scalar Function 2D Visualizer Runner" -ForegroundColor Green
Write-Host "========================================" -ForegroundColor Green
Write-Host ""
