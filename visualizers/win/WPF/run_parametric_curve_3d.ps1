...
# Using WPF MML_ParametricCurve3D_Visualizer

# Configuration
$ScriptDir = Split-Path -Parent $MyInvocation.MyCommand.Path
$VisualizerPath = Join-Path $ScriptDir "parametric_curve_3d_visualizer\MML_ParametricCurve3D_Visualizer.exe"
$DataDir = Join-Path $ScriptDir "..\..\..\data\ParametricCurve3D\Basic"

# Color settings
$Host.UI.RawUI.ForegroundColor = "Cyan"

Write-Host "========================================" -ForegroundColor Green
Write-Host "Parametric Curve 3D Visualizer Runner" -ForegroundColor Green
Write-Host "========================================" -ForegroundColor Green
Write-Host ""
