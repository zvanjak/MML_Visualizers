...
# Using WPF MML_ParticleVisualizer3D

# Configuration
$ScriptDir = Split-Path -Parent $MyInvocation.MyCommand.Path
$VisualizerPath = Join-Path $ScriptDir "particle_3d_visualizer\MML_ParticleVisualizer3D.exe"
$DataDir = Join-Path $ScriptDir "..\..\..\data\ParticleVisualizer3D\Basic"

# Color settings
$Host.UI.RawUI.ForegroundColor = "Cyan"

Write-Host "========================================" -ForegroundColor Green
Write-Host "Particle Visualizer 3D Runner" -ForegroundColor Green
Write-Host "========================================" -ForegroundColor Green
Write-Host ""
