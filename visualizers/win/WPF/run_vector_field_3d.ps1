...
# Using WPF MML_VectorField3D_Visualizer

# Configuration
$ScriptDir = Split-Path -Parent $MyInvocation.MyCommand.Path
$VisualizerPath = Join-Path $ScriptDir "vector_field_3d_visualizer\MML_VectorField3D_Visualizer.exe"
$DataDir = Join-Path $ScriptDir "..\..\..\data\VectorFieldVisualizer3D\Basic"

# Color settings
$Host.UI.RawUI.ForegroundColor = "Cyan"

Write-Host "========================================" -ForegroundColor Green
Write-Host "Vector Field 3D Visualizer Runner" -ForegroundColor Green
Write-Host "========================================" -ForegroundColor Green
Write-Host ""
