...
# Using FLTK MML_VectorField2D_Visualizer_FLTK

# Configuration
$ScriptDir = Split-Path -Parent $MyInvocation.MyCommand.Path
$VisualizerPath = Join-Path $ScriptDir "MML_VectorField2D_Visualizer_FLTK.exe"
...
Write-Host "  Vector Field 2D Visualizer Runner" -ForegroundColor Green
