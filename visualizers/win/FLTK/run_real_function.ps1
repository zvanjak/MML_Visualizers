...
# Using FLTK MML_RealFunctionVisualizer_FLTK

# Configuration
$ScriptDir = Split-Path -Parent $MyInvocation.MyCommand.Path
$VisualizerPath = Join-Path $ScriptDir "MML_RealFunctionVisualizer_FLTK.exe"
...
# Get all .txt files from the data directory (root level only, excluding subdirectories)
$DataFiles = Get-ChildItem -Path $DataDir -Filter "*.txt" -File | Sort-Object Name
