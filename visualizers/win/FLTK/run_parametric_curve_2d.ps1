...
# Using FLTK MML_ParametricCurve2D_Visualizer_FLTK

# Configuration
$ScriptDir = Split-Path -Parent $MyInvocation.MyCommand.Path
$VisualizerPath = Join-Path $ScriptDir "MML_ParametricCurve2D_Visualizer_FLTK.exe"
$DataDir = Join-Path $ScriptDir "..\..\..\data\ParametricCurve2D\Basic"

# Color settings
$Host.UI.RawUI.ForegroundColor = "Cyan"

Write-Host "========================================" -ForegroundColor Green
Write-Host "Parametric Curve 2D Visualizer Runner" -ForegroundColor Green
